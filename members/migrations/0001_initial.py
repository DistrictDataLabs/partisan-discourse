    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biography', markupfield.fields.MarkupField(blank=True, default=None, help_text='Edit in Markdown', null=True, rendered_field=True)),
                ('twitter', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('biography_markup_type', models.CharField(choices=[('', '--'), ('html', 'HTML'), ('plain', 'Plain'), ('markdown', 'Markdown')], default='markdown', editable=False, max_length=30)),
